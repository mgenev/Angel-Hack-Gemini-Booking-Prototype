angular.module('mean.reservations').controller('ReservationsController', ['$scope', '$routeParams', '$location', 'Global', 'Reservations', function ($scope, $routeParams, $location, Global, Reservations, Clients, Services, Users) {
    $scope.global = Global;
